...
SELECT c.customer_id, c.customer_name, SUM(p.unit_price * oi.quantity) AS total_order_value
FROM Customers c
...
SELECT r.rep_id, r.rep_name, COUNT(DISTINCT o.customer_id) AS unique_customers
FROM Sales_Reps r
